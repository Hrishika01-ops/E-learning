...
courseRouter.delete('/unenroll/:courseId', unenrollFromCourse);
...
courseRouter.put('/:id', authorizeRoles(['Instructor']), updateCourse);
courseRouter.delete('/:id', authorizeRoles(['Instructor']), deleteCourse);

// Lesson management
courseRouter.post('/:courseId/lessons', authorizeRoles(['Instructor']), addLesson);
courseRouter.get('/:courseId/lessons/:lessonId', getLessonById);
courseRouter.put('/:courseId/lessons/:lessonId', authorizeRoles(['Instructor']), updateLesson);
courseRouter.delete('/:courseId/lessons/:lessonId', authorizeRoles(['Instructor']), deleteLesson);
